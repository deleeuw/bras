...
\author{Jan de Leeuw}
\date{First created May 03, 2016. Last update July 14, 2021}
...
{\centering \includegraphics[width=10.82in]{graphics/bookfig1} 
...
It should be noted that this book is a corrected, updated, and expanded version of a twenty-five year old chapter in a conference proceedings volume (\protect\hyperlink{ref-deleeuw_C_94c}{De Leeuw 1994}). It will not be possible to erase all the traces of these humble beginnings. Specifically, references will often be to material from before 1994, and more recent work will probably be less completely covered.
...
Around 1975, however, De Leeuw greatly extended the scope of ALS by using \emph{majorization}. This was first applied to Euclidean multidimensional scaling by \protect\hyperlink{ref-deleeuw_C_77}{De Leeuw} (\protect\hyperlink{ref-deleeuw_C_77}{1977}), but it became clear early on that majorization was a general technique for algorithm construction that also covered, for example, the EM algorithm, which was discovered around the same time (\protect\hyperlink{ref-dempster_laird_rubin_77}{Dempster, Laird, and Rubin} (\protect\hyperlink{ref-dempster_laird_rubin_77}{1977})). In each iteration of a majorization algorithm we construct a \emph{surrogate function} (\protect\hyperlink{ref-lange_hunter_yang_00}{Lange, Hunter, and Yang} (\protect\hyperlink{ref-lange_hunter_yang_00}{2000})) or \emph{majorization} (\protect\hyperlink{ref-deleeuw_C_94c}{De Leeuw} (\protect\hyperlink{ref-deleeuw_C_94c}{1994}), \protect\hyperlink{ref-heiser_95}{Heiser} (\protect\hyperlink{ref-heiser_95}{1995})) that lies above the function we are minimizing and touches it in the current iterate. We then minimize this surrogate function to find an update of the current iterate, then construct a new majorization function in that update, and so on. The majorization function, if suitably chosen, can often be minimized using ALS techniques.

\protect\hyperlink{ref-deleeuw_C_94c}{De Leeuw} (\protect\hyperlink{ref-deleeuw_C_94c}{1994}) argues there is another important class of algorithms extending ALS. It is intermediate, since it is a special case of block relaxation and it contains majorization as a special case. In \emph{augmentation methods} for the minimization of a real valued function we introduce an \emph{augmentation}, which uses an additional vector of variables, with a surrogate function on the product of both sets, such that the original objective function is the minimum of the surrogate function over the augmenting block of variables. We then apply block relaxation to the augmented function.
...
\hypertarget{blockrelaxation:generalizedblockrelaxation:raschmodel}{%
\subsection{Rasch Model}\label{blockrelaxation:generalizedblockrelaxation:raschmodel}}
...
\hypertarget{blockrelaxation:generalizedblockrelaxation:nonlinearleastsquares}{%
\subsection{Nonlinear Least Squares}\label{blockrelaxation:generalizedblockrelaxation:nonlinearleastsquares}}
...
\hypertarget{blockrelaxation:blockorder}{%
\section{Block Order}\label{blockrelaxation:blockorder}}
...
\hypertarget{blockrelaxation:blockorder:projectingblocks}{%
\subsection{Projecting Blocks}\label{blockrelaxation:blockorder:projectingblocks}}

\hypertarget{blockrelaxation:rateofconvergence}{%
\section{Rate of Convergence}\label{blockrelaxation:rateofconvergence}}

\hypertarget{blockrelaxation:rateofconvergence:luform}{%
\subsection{LU-form}\label{blockrelaxation:rateofconvergence:luform}}
...
\hypertarget{blockrelaxation:rateofconvergence:productform}{%
\subsection{Product Form}\label{blockrelaxation:rateofconvergence:productform}}
...
\hypertarget{blockrelaxation:rateofconvergence:blockoptimizationmethods}{%
\subsection{Block Optimization Methods}\label{blockrelaxation:rateofconvergence:blockoptimizationmethods}}
...
\hypertarget{blockrelaxation:rateofconvergence:blocknewtonmethods}{%
\subsection{Block Newton Methods}\label{blockrelaxation:rateofconvergence:blocknewtonmethods}}
...
\hypertarget{blockrelaxation:rateofconvergence:constrainedproblems}{%
\subsection{Constrained Problems}\label{blockrelaxation:rateofconvergence:constrainedproblems}}
...
\hypertarget{blockrelaxation:additionalexamples}{%
\section{Additional Examples}\label{blockrelaxation:additionalexamples}}

\hypertarget{blockrelaxation:additionalexamples:canonicalcorrelation}{%
\subsection{Canonical Correlation}\label{blockrelaxation:additionalexamples:canonicalcorrelation}}
...
\hypertarget{blockrelaxation:additionalexamples:lowrankapproximation}{%
\subsection{Low Rank Approximation}\label{blockrelaxation:additionalexamples:lowrankapproximation}}
...
\hypertarget{blockrelaxation:additionalexamples:optimalscalingwithlineals}{%
\subsection{Optimal Scaling with LINEALS}\label{blockrelaxation:additionalexamples:optimalscalingwithlineals}}
...
\protect\hyperlink{ref-deleeuw_A_88a}{De Leeuw} (\protect\hyperlink{ref-deleeuw_A_88a}{1988}) has suggested to find standardized quantifications in such a way that the loss function
\[
...
\hypertarget{blockrelaxation:additionalexamples:multinormalmaximumlikelihood}{%
\subsection{Multinormal Maximum Likelihood}\label{blockrelaxation:additionalexamples:multinormalmaximumlikelihood}}
...
\hypertarget{blockrelaxation:additionalexamples:arraymultinormals}{%
\subsection{Array Multinormals}\label{blockrelaxation:additionalexamples:arraymultinormals}}

\hypertarget{blockrelaxation:additionalexamples:raschmodel}{%
\subsection{Rasch Model}\label{blockrelaxation:additionalexamples:raschmodel}}
...
\hypertarget{blockrelaxation:somecounterexamples}{%
\section{Some Counterexamples}\label{blockrelaxation:somecounterexamples}}

\hypertarget{blockrelaxation:somecounterexamples:convergencetoasaddle}{%
\subsection{Convergence to a Saddle}\label{blockrelaxation:somecounterexamples:convergencetoasaddle}}
...
{\centering \includegraphics{_main_files/figure-latex/saddlecontour-1} 
...
{\centering \includegraphics{_main_files/figure-latex/saddlepersp-1} 
...
\hypertarget{blockrelaxation:somecounterexamples:convergencetoincorrectsolutions}{%
\subsection{Convergence to Incorrect Solutions}\label{blockrelaxation:somecounterexamples:convergencetoincorrectsolutions}}
...
\begin{center}\includegraphics{_main_files/figure-latex/uprule-1} \end{center}

Figure 1: The UP, LOW, MID and RANDOM rules

\hypertarget{blockrelaxation:somecounterexamples:nonconvergenceandcycling}{%
\subsection{Non-convergence and Cycling}\label{blockrelaxation:somecounterexamples:nonconvergenceandcycling}}
...
\hypertarget{blockrelaxation:somecounterexamples:sublinearconvergence}{%
\subsection{Sublinear Convergence}\label{blockrelaxation:somecounterexamples:sublinearconvergence}}
...
\hypertarget{coordinatedescent}{%
\chapter{Coordinate Descent}\label{coordinatedescent}}

\hypertarget{coordinatedescent:introduction}{%
\section{Introduction}\label{coordinatedescent:introduction}}
...
\hypertarget{coordinatedescent:convergencerate}{%
\section{Convergence rate}\label{coordinatedescent:convergencerate}}
...
\hypertarget{coordinatedescent:examples}{%
\section{Examples}\label{coordinatedescent:examples}}

\hypertarget{coordinatedescent:examples:thecartesianfolium}{%
\subsection{The Cartesian Folium}\label{coordinatedescent:examples:thecartesianfolium}}
...
\begin{center}\includegraphics{_main_files/figure-latex/folium-1} \end{center}

Figure 1: Folium, two scales, two sections

Now apply coordinate descent (\protect\hyperlink{ref-deleeuw_U_07e}{De Leeuw} (\protect\hyperlink{ref-deleeuw_U_07e}{2007b})).
...
\hypertarget{coordinatedescent:examples:afamilyofquadratics}{%
\subsection{A Family of Quadratics}\label{coordinatedescent:examples:afamilyofquadratics}}
...
\hypertarget{coordinatedescent:examples:loglinearmodels}{%
\subsection{Loglinear Models}\label{coordinatedescent:examples:loglinearmodels}}
...
\hypertarget{coordinatedescent:examples:rayleighquotient}{%
\subsection{Rayleigh Quotient}\label{coordinatedescent:examples:rayleighquotient}}
...
{\centering \includegraphics[width=6.67in]{graphics/rcase2} 
...
{\centering \includegraphics[width=6.67in]{graphics/rcase3} 
...
\hypertarget{coordinatedescent:examples:squareddistancescaling}{%
\subsection{Squared Distance Scaling}\label{coordinatedescent:examples:squareddistancescaling}}
...
\hypertarget{coordinatedescent:examples:leastsquaresfactoranalysis}{%
\subsection{Least Squares Factor Analysis}\label{coordinatedescent:examples:leastsquaresfactoranalysis}}

\hypertarget{alternatingleastsquares}{%
\chapter{Alternating Least Squares}\label{alternatingleastsquares}}

\hypertarget{alternatingleastsquares:introduction}{%
\section{Introduction}\label{alternatingleastsquares:introduction}}
...
\hypertarget{alternatingleastsquares:closerelatives}{%
\section{Close Relatives}\label{alternatingleastsquares:closerelatives}}

\hypertarget{alternatingleastsquares:closerelatives:alsos}{%
\subsection{ALSOS}\label{alternatingleastsquares:closerelatives:alsos}}
...
\hypertarget{alternatingleastsquares:closerelatives:ace}{%
\subsection{ACE}\label{alternatingleastsquares:closerelatives:ace}}
...
\hypertarget{alternatingleastsquares:closerelatives:nipalsandpls}{%
\subsection{NIPALS and PLS}\label{alternatingleastsquares:closerelatives:nipalsandpls}}

\hypertarget{alternatingleastsquares:rateofconvergence}{%
\section{Rate of Convergence}\label{alternatingleastsquares:rateofconvergence}}
...
\hypertarget{alternatingleastsquares:examples}{%
\section{Examples}\label{alternatingleastsquares:examples}}

\hypertarget{alternatingleastsquares:examples:homogeneityanalysis}{%
\subsection{Homogeneity Analysis}\label{alternatingleastsquares:examples:homogeneityanalysis}}

\hypertarget{alternatingleastsquares:examples:fixedrankapproximation}{%
\subsection{Fixed Rank Approximation}\label{alternatingleastsquares:examples:fixedrankapproximation}}

\hypertarget{alternatingleastsquares:examples:multilinearfitting}{%
\subsection{Multilinear Fitting}\label{alternatingleastsquares:examples:multilinearfitting}}

\hypertarget{alternatingleastsquares:examples:mcrals}{%
\subsection{MCR-ALS}\label{alternatingleastsquares:examples:mcrals}}

\hypertarget{alternatingleastsquares:examples:scalingandsplitting}{%
\subsection{Scaling and Splitting}\label{alternatingleastsquares:examples:scalingandsplitting}}
...
\hypertarget{augmentation-and-decomposition-methods}{%
\chapter{Augmentation and Decomposition Methods}\label{augmentation-and-decomposition-methods}}
...
\hypertarget{rate-of-convergenc}{%
\section{Rate of Convergenc}\label{rate-of-convergenc}}
...
\hypertarget{half-quadratic-methods}{%
\section{Half-Quadratic Methods}\label{half-quadratic-methods}}
...
\hypertarget{yates-augmentation}{%
\subsection{Yates Augmentation}\label{yates-augmentation}}
...
\hypertarget{optimal-scaling-with-ordinals}{%
\subsection{Optimal Scaling with ORDINALS}\label{optimal-scaling-with-ordinals}}
...
\subsection{Least Squares Factor Analysis}\label{least-squares-factor-analysis}}
...
\hypertarget{squared-distance-scaling}{%
\subsection{Squared Distance Scaling}\label{squared-distance-scaling}}
...
An augmentation algorithm for this problem, modestly called ELEGANT, was designed by \protect\hyperlink{ref-deleeuw_U_75b}{De Leeuw} (\protect\hyperlink{ref-deleeuw_U_75b}{1975}). That paper was never published and the
...
This example is taken from a paper of \protect\hyperlink{ref-deleeuw_liu_R_93}{De Leeuw and Liu} (\protect\hyperlink{ref-deleeuw_liu_R_93}{1993}), which describes the
...
\section{Decomposition Methods}\label{decomposition-methods}}
...
\hypertarget{quadratic-form-on-a-sphere}{%
\subsection{Quadratic Form on a Sphere}\label{quadratic-form-on-a-sphere}}
...
\hypertarget{multidimensional-unfolding}{%
\subsection{Multidimensional Unfolding}\label{multidimensional-unfolding}}
...
\hypertarget{majorization-methods}{%
\chapter{Majorization Methods}\label{majorization-methods}}
...
\hypertarget{majorization-at-a-point}{%
\subsection{Majorization at a Point}\label{majorization-at-a-point}}
...
\begin{center}\includegraphics{_main_files/figure-latex/loog-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/cubby-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/infty-1} \end{center}
...
\hypertarget{majorization-on-a-set}{%
\subsection{Majorization on a Set}\label{majorization-on-a-set}}
...
{\centering \includegraphics[width=19.39in]{graphics/logitcouple} 
...
{\centering \includegraphics{_main_files/figure-latex/interplanes-1} 
...
{\centering \includegraphics{_main_files/figure-latex/logitother-1} 
...
\hypertarget{majorization-algorithm}{%
\subsection{Majorization Algorithm}\label{majorization-algorithm}}
...
\begin{center}\includegraphics{_main_files/figure-latex/bookfig5-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/cobexample-1} \end{center}

Figure 2

\hypertarget{alternative-definitions}{%
\subsection{Alternative Definitions}\label{alternative-definitions}}
...
\begin{center}\includegraphics{_main_files/figure-latex/strange-1} \end{center}

\hypertarget{relatives}{%
\section{Relatives}\label{relatives}}

\hypertarget{the-concave-convex-procedure}{%
\subsection{The Concave-Convex Procedure}\label{the-concave-convex-procedure}}
...
\hypertarget{generalized-weiszfeld-methods}{%
\subsection{Generalized Weiszfeld Methods}\label{generalized-weiszfeld-methods}}

We discuss Weiszfeld's algorithm for the single facility location problem, or equivalently for the spatial median problem, in \href{../inequalities/location.md}{section 7.3.2}. But, in an important early article, \protect\hyperlink{ref-vosz_eckhardt_80}{Vosz and Eckhardt} (\protect\hyperlink{ref-vosz_eckhardt_80}{1980}) pointed out that Weiszfeld's
...
\hypertarget{the-lower-bound-principle}{%
\subsection{The Lower-Bound Principle}\label{the-lower-bound-principle}}
...
\hypertarget{univariate-and-separable-functions}{%
\subsection{Univariate and Separable Functions}\label{univariate-and-separable-functions}}
...
As pointed out by
\protect\hyperlink{ref-deleeuw_lange_A_09}{De Leeuw and Lange} (\protect\hyperlink{ref-deleeuw_lange_A_09}{2009}) looking at the univariate case is obviously restrictive, but not as restrictive as it seems. Many
...
\hypertarget{differentiable-functions}{%
...
\hypertarget{majorization-duality}{%
\subsection{Majorization Duality}\label{majorization-duality}}
...
\hypertarget{necessary-conditions-by-majorization}{%
\subsection{Necessary Conditions by Majorization}\label{necessary-conditions-by-majorization}}
...
\hypertarget{majorizing-constraints}{%
\subsection{Majorizing Constraints}\label{majorizing-constraints}}
...
\hypertarget{majorizing-value-functions}{%
\subsection{Majorizing Value Functions}\label{majorizing-value-functions}}
...
\hypertarget{the-reciprocal}{%
\subsection{The Reciprocal}\label{the-reciprocal}}
...
\begin{center}\includegraphics{_main_files/figure-latex/afuncs-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/maj3-1} \end{center}

Figure 2: Majorization of 3x/2+log(x) at y=1/10,1, and 3/2

\hypertarget{cubics-and-quartics}{%
\subsection{Cubics and Quartics}\label{cubics-and-quartics}}
...
\begin{center}\includegraphics{_main_files/figure-latex/qcm-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/ex2-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/symq-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/qcub-1} \end{center}
...
\hypertarget{normal-pdf-and-cdf}{%
\subsection{Normal PDF and CDF}\label{normal-pdf-and-cdf}}
...
\begin{center}\includegraphics{_main_files/figure-latex/normal-1} \end{center}
...
\hypertarget{logistic-pdf-and-cdf}{%
\subsection{Logistic PDF and CDF}\label{logistic-pdf-and-cdf}}

\hypertarget{majorization-inequalities}{%
\chapter{Majorization Inequalities}\label{majorization-inequalities}}
...
\subsection{Absolute Values}\label{absolute-values}}
...
\hypertarget{location-problems}{%
\subsection{Location Problems}\label{location-problems}}
...
\hypertarget{polar-norms-and-the-cauchy-schwarz-inequality}{%
\section{Polar Norms and the Cauchy-Schwarz Inequality}\label{polar-norms-and-the-cauchy-schwarz-inequality}}
...
scaling, developed by \protect\hyperlink{ref-deleeuw_C_77}{De Leeuw} (\protect\hyperlink{ref-deleeuw_C_77}{1977}).
We want to minimize
\[
...
\hypertarget{conjugates-and-youngs-inequality}{%
\section{Conjugates and Young's Inequality}\label{conjugates-and-youngs-inequality}}
...
\begin{center}\includegraphics[width=6.67in]{graphics/ozo} \end{center}

\begin{center}\includegraphics[width=6.67in]{graphics/aza} \end{center}
...
\hypertarget{the-em-algorithm-1}{%
\section{The EM Algorithm}\label{the-em-algorithm-1}}
...
\hypertarget{tangential-majorization}{%
\chapter{Tangential Majorization}\label{tangential-majorization}}

\hypertarget{using-the-tangent}{%
\section{Using the Tangent}\label{using-the-tangent}}
...
\begin{center}\includegraphics{_main_files/figure-latex/mylog-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/morelog-1} \end{center}
...
\protect\hyperlink{ref-deleeuw_C_04a}{De Leeuw} (\protect\hyperlink{ref-deleeuw_C_04a}{2004}) discusses the problem of finding an approximate solution to the homogeneous linear system \(AB=0\) when there are cone and orthonormality restrictions on the columns of \(A\) and when some elements of \(B\) are restricted to known values, most commonly to zero. Think of the columns of \(A\) as variables or sets of variables, and think of \(B\) as regression coefficients or weights.

The loss function used by \protect\hyperlink{ref-deleeuw_C_04a}{De Leeuw} (\protect\hyperlink{ref-deleeuw_C_04a}{2004}) is
\[
...
The constraints on \(A\) discussed in \protect\hyperlink{ref-deleeuw_C_04a}{De Leeuw} (\protect\hyperlink{ref-deleeuw_C_04a}{2004}) make it possible to fit a wide variety of multivariate analysis techniques. Columns of \(A\), or variables, are partitioned into blocks. Some blocks contain only a single variable, such variables are called \emph{single}. Some blocks are constrained to be orthoblocks, which means that the variabes in the block are required to be orthonormal. Single variables may be cone-constrained, which means the corresponding column of \(A\) is
...
We first study the univariate case, following \protect\hyperlink{ref-deleeuw_lange_A_09}{De Leeuw and Lange} (\protect\hyperlink{ref-deleeuw_lange_A_09}{2009}). If a quadratic \(g\) majorizes a differentiable \(f\) over \(\mathcal{X}\) at \(y\) then we must have
\[
...
{\centering \includegraphics[width=7in]{graphics/cali} 
...
\begin{center}\includegraphics{_main_files/figure-latex/pnorm-1} \end{center}

Figure 1: Quadratic Majorization of Normal Distribution

\begin{center}\includegraphics{_main_files/figure-latex/dnorm-1} \end{center}
...
\hypertarget{marginal-functions}{%
\subsection{Marginal Functions}\label{marginal-functions}}
...
\hypertarget{mean-value-majorization}{%
\section{Mean Value Majorization}\label{mean-value-majorization}}
...
\begin{center}\includegraphics{_main_files/figure-latex/logders-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/minplot-1} \end{center}
...
the \emph{sharpest quadratic majorization} of \(f\) at \(y\) (\protect\hyperlink{ref-deleeuw_lange_A_09}{De Leeuw and Lange 2009}).
...
If \(f\) is convex we can generalize the tangential majorization algorithm of \protect\hyperlink{ref-deleeuw_lange_A_09}{De Leeuw and Lange} (\protect\hyperlink{ref-deleeuw_lange_A_09}{2009}), section 6, to compute \(\beta.\)
For convex \(f\)
\[
...
\begin{center}\includegraphics{_main_files/figure-latex/three-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/cosine-1} \end{center}
...
{\centering \includegraphics[width=6.67in]{graphics/cobweb001} 
...
{\centering \includegraphics[width=6.67in]{graphics/cobweb249} 
...
\begin{center}\includegraphics{_main_files/figure-latex/qtwothree-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/qhalf-1} \end{center}
...
{\centering \includegraphics[width=10.89in]{graphics/bookfig3} 
...
we refer to \protect\hyperlink{ref-deleeuw_A_82b}{De Leeuw} (\protect\hyperlink{ref-deleeuw_A_82b}{1982}).
...
\begin{center}\includegraphics{_main_files/figure-latex/secular1-1} \end{center}
...
\begin{center}\includegraphics{_main_files/figure-latex/secular2-1} \end{center}
...
This appendix summarizes some of the results in \protect\hyperlink{ref-deleeuw_R_07c}{De Leeuw} (\protect\hyperlink{ref-deleeuw_R_07c}{2007a}), \protect\hyperlink{ref-deleeuw_R_08b}{De Leeuw} (\protect\hyperlink{ref-deleeuw_R_08b}{2008}), and \protect\hyperlink{ref-deleeuw_sorenson_U_12b}{De Leeuw and Sorenson} (\protect\hyperlink{ref-deleeuw_sorenson_U_12b}{2012}). We refer to those reports for more extensive calculations and applications.
...
{\centering \includegraphics{_main_files/figure-latex/cobnewton-1} 
...
De Leeuw, J. 1968. {``Nonmetric Discriminant Analysis.''} Research Note 06-68. Department of Data Theory, University of Leiden. \url{http://deleeuwpdx.net/janspubs/1968/reports/deleeuw_R_68d.pdf}.
...
---------. 1977. {``Applications of Convex Analysis to Multidimensional Scaling.''} In \emph{Recent Developments in Statistics}, edited by J. R. Barra, F. Brodeau, G. Romier, and B. Van Cutsem, 133--45. Amsterdam, The Netherlands: North Holland Publishing Company. \url{http://deleeuwpdx.net/janspubs/1977/chapters/deleeuw_C_77.pdf}.

\leavevmode\hypertarget{ref-deleeuw_A_82b}{}%
---------. 1982. {``{Generalized Eigenvalue Problems with Positive Semidefinite Matrices}.''} \emph{Psychometrika} 47: 87--94. \url{http://deleeuwpdx.net/janspubs/1982/articles/deleeuw_A_82b.pdf}.

\leavevmode\hypertarget{ref-deleeuw_A_88a}{}%
---------. 1988. {``Multivariate Analysis with Linearizable Regressions.''} \emph{Psychometrika} 53: 437--54. \url{http://deleeuwpdx.net/janspubs/1988/articles/deleeuw_A_88a.pdf}.
...
---------. 2007a. {``Derivatives of Generalized Eigen Systems with Applications.''} Preprint Series 528. Los Angeles, CA: UCLA Department of Statistics. \url{http://deleeuwpdx.net/janspubs/2007/reports/deleeuw_R_07c.pdf}.

\leavevmode\hypertarget{ref-deleeuw_U_07e}{}%
---------. 2007b. {``{Minimizing the Cartesian Folium}.''} \url{http://deleeuwpdx.net/janspubs/2007/notes/deleeuw_U_07e.pdf}.

\leavevmode\hypertarget{ref-deleeuw_R_08b}{}%
---------. 2008. {``{Derivatives of Fixed-Rank Approximations}.''} Preprint Series 547. Los Angeles, CA: UCLA Department of Statistics. \url{http://deleeuwpdx.net/janspubs/2008/reports/deleeuw_R_08b.pdf}.

\leavevmode\hypertarget{ref-deleeuw_lange_A_09}{}%
De Leeuw, J., and K. Lange. 2009. {``Sharp Quadratic Majorization in One Dimension.''} \emph{Computational Statistics and Data Analysis} 53: 2471--84. \url{https://doi.org/10.1016/j.csda.2009.01.002}.

\leavevmode\hypertarget{ref-deleeuw_liu_R_93}{}%
De Leeuw, J., and G. Liu. 1993. {``Majorization Algorithms for Mixed Model Analysis.''} Preprint 115. Los Angeles, CA: UCLA Statistics. \url{http://deleeuwpdx.net/janspubs/1993/reports/deleeuw_liu_R_93.pdf}.
...
Dontchev, A. L., and R. T. Rockafellar. 2014. \emph{Implicit Functions and Solution Mappings}. Second Edition. Springer Series in Operations Research and Financial Engineering. Springer.
...
Harman, H. H., and W. H. Jones. 1966. {``{Factor Analysis by Minimizing Residuals }.''} \emph{Psychometrika} 31: 351--68.
